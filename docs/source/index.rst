...
**edaflow** simplifies and accelerates the EDA process by providing a collection of 14 powerful functions for data scientists and analysts. The package integrates popular data science libraries to create a cohesive workflow for data exploration, visualization, and preprocessing.
...
.. code-block:: python
   ...
   # Complete EDA workflow with 14 functions
...
edaflow provides 14 comprehensive EDA functions organized into logical categories:
